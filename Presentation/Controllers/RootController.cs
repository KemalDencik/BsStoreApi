...
namespace Presentation.Controllers
{
    ...
    public class RootController:ControllerBase
    {
        ...
        {
            if (mediaType.Contains("application/vnd.WepApi.apiroot"))//contains içeriyor ise
            {
                var list = new List<Link>()
                {
                     ...
                     new Link()
                    {
                     ...
                     //kaynak oluşturabileceği 
                      new Link()
                    {
                        Href=_linkGenerator.GetUriByName(HttpContext, nameof(BooksController.CreateOneBooksAsync),new{}),
                        Rel="_book",
                        Method="POST",
                    }
                };
